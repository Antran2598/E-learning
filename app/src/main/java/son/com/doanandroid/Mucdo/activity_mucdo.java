...
public class activity_mucdo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btnde.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_mucdo.this, activity_test.class);

                // gan vao name muc co gia tri la De
                intent.putExtra("muc", "De");
                startActivity(intent);
                MediaPlayer mediaPlayer;
                mediaPlayer = MediaPlayer.create(activity_mucdo.this, R.raw.flute);
                mediaPlayer.start();
            }
        });
        btntrungbinh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                MediaPlayer mediaPlayer;
                mediaPlayer = MediaPlayer.create(activity_mucdo.this, R.raw.bf);
                mediaPlayer.start();
            }
        });
        btnkho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                MediaPlayer mediaPlayer;
                mediaPlayer = MediaPlayer.create(activity_mucdo.this, R.raw.ps1cg);
                mediaPlayer.start();
            }
        });
        ...
        Quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activity_mucdo.this, activity_trangchu.class);
                startActivity(intent);
            }
        });
    }
