...
public class activity_mucdo2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btnde.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_mucdo2.this,son.com.doanandroid.Activities.activity_test2.class);

                // gan vao name muc co gia tri la De
                intent.putExtra("muc", "De");
                startActivity(intent);
                MediaPlayer mediaPlayer;
                mediaPlayer = MediaPlayer.create(activity_mucdo2.this, R.raw.flute);
                mediaPlayer.start();
            }
        });
        btntrungbinh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                MediaPlayer mediaPlayer;
                mediaPlayer = MediaPlayer.create(activity_mucdo2.this, R.raw.bf);
                mediaPlayer.start();
            }
        });
        btnkho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                MediaPlayer mediaPlayer;
                mediaPlayer = MediaPlayer.create(activity_mucdo2.this, R.raw.ps1cg);
                mediaPlayer.start();
            }
        });
        ...
        Quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activity_mucdo2.this, activity_trangchu.class);
                startActivity(intent);
            }
        });
    }
