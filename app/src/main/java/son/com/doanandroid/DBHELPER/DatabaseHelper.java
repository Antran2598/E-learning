package son.com.doanandroid.DBHELPER;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<Question> getQuestion(String muc){
        ...
        //CURSOR LÀ MỘT BẢNG KẾT QUẢ LẤY ĐƯỢC TỪ CÂU TRUY VẤN ĐÃ TRUYỀN VÀO Ở ĐÂY LÀ SELECT * FROM QUETSTION_TABLE , THAM SỐ THỨ HAI LIÊN QUAN TỚI MỆNH ĐỀ WHERE , DO KHÔNG SỬ DỤNG NÊN ĐỂ NULL
        ...
        if(cursor.moveToFirst()){
            ...
            do {
                ...
                String Traloi = cursor.getString(7);
